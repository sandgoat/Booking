              ...
              <Col md="6" className="hero-welcome-wrapper">
                <div className="hero-welcome-text">
                  <h1>
                    ...
                    Welcome to the portfolio website of Ryan Grant.
                    Get informed, collaborate and discover projects I have worked on over the years!
                  </h1>
                </div>
                <Typed
                  loop
